...
public class RobotCamera {
    private static final String TAG = RobotCamera.class.getSimpleName();
    ...
    private static class InstanceHolder {
        private static RobotCamera mRobotCamera = new RobotCamera();
    }

    public static RobotCamera getInstance() {
        return InstanceHolder.mRobotCamera;
    }
    ...
    public void initializeCamera(Context context,
        ...
        try {
            ...
            Log.d(TAG, "RobotCamera access exception", cae);
        }
    }
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onDisconnected(CameraDevice cameraDevice) {
            Log.d(TAG, "RobotCamera disconnected, closing.");
            cameraDevice.close();
        }

        @Override
        public void onError(CameraDevice cameraDevice, int i) {
            Log.d(TAG, "RobotCamera device error, closing.");
            cameraDevice.close();
        }
    ...
    public void takePicture() {
        if (mCameraDevice == null) {
            Log.w(TAG, "Cannot capture image. RobotCamera not initialized.");
            return;
        }
